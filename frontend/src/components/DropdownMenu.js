    ...
    return (
        <>
            <Popover className={`relative`}>
                <Popover.Button className="py-1 px-2 right-1.5 top-2 hover:bg-slate-200 rounded-sm focus:outline-none focus:ring focus:ring-gray-200" >
                ...
                <Popover.Panel className="absolute z-10 left-0">
                    <div className="w-40 bg-white rounded-md border shadow select-none p-1 divide-y">
                        <div className='py-[3px]'>
                            <button onClick={(e) => handleSetEditModal(e)} className='transition-colors duration-75 flex w-full items-center rounded-md px-2.5 py-2 text-sm space-x-2.5 text-slate-500 hover:bg-gray-500 hover:text-gray-100'>
